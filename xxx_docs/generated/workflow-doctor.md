...
- generated_at_utc: 2026-02-13 13:28:55Z
...
| Path exists: .codex/skills/memory-context/SKILL.md | PASS | E:\docc\silver-bullet-kernel\.codex\skills\memory-context\SKILL.md | Regenerate or restore missing workflow asset. |
...
| Path exists: scripts/memory-context.ps1 | PASS | E:\docc\silver-bullet-kernel\scripts\memory-context.ps1 | Regenerate or restore missing workflow asset. |
...
| Path exists: xxx_docs/00-index.md | FAIL | E:\docc\silver-bullet-kernel\xxx_docs\00-index.md | Regenerate or restore missing workflow asset. |
