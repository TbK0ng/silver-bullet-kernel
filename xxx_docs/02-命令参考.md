...
**输出：** 控制台 + `.metrics/workflow-doctor.md`
...
**输出：** `.metrics/workflow-policy-gate.md`
...
**输出：** `.metrics/workflow-indicator-gate.md`
...
**数据来源：** `.metrics/verify-runs.jsonl`
