...
```powershell
openspec new change add-task-priority
```

然后最少补齐：

- `openspec/changes/add-task-priority/proposal.md`
- `openspec/changes/add-task-priority/design.md`
- `openspec/changes/add-task-priority/tasks.md`
- `openspec/changes/add-task-priority/specs/<capability>/spec.md`
...
```powershell
openspec archive add-task-priority -y
```
